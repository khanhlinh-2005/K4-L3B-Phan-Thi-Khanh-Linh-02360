...
Nhóm chọn chủ đề này vì chính sách trả hàng/hoàn tiền có nhiều điều kiện, thời hạn, phương thức và ngoại lệ. Đây là dữ liệu rất phù hợp để đánh giá retrieval vì câu hỏi thường đòi hỏi trả lời dựa trên các mốc thời hạn, điều kiện và quy trình. Tài liệu có cấu trúc rõ ràng và thân thiện với metadata filtering (`buyer`, `category`, `language`).

### Danh sách tài liệu (Data Inventory)

| # | Tên tài liệu | Nguồn (Source URL) | Ngày lấy / Phiên bản | Số ký tự | Metadata đã gán |
|---|--------------|------------|--------------------|----------|-----------------|
| 1 | shopee-quy-dinh-chung-tra-hang-hoan-tien.md | https://help.shopee.vn/portal/4/article/188931 | 2026-09-20 / v1 | 7,427 | buyer; returns-policy; vi |
| 2 | shopee-huong-dan-gui-yeu-cau-tra-hang.md | https://help.shopee.vn/portal/4/article/79233 | 2026-09-20 / v1 | 4,054 | buyer; returns-policy; vi |
| 3 | shopee-phuong-thuc-va-phi-tra-hang.md | https://help.shopee.vn/portal/4/article/189477 | 2026-09-20 / v1 | 6,923 | buyer; returns-policy; vi |
| 4 | shopee-thoi-gian-va-cach-kiem-tra-tien-hoan.md | https://help.shopee.vn/portal/4/article/189473 | 2026-09-20 / v1 | 4,800 | buyer; returns-policy; vi |
| 5 | shopee-huong-dan-chuan-bi-bang-chung.md | https://help.shopee.vn/portal/4/article/79467 | 2026-09-20 / v1 | 5,129 | buyer; returns-policy; vi |
| 6 | shopee-quy-trinh-xu-ly-tra-hang.md | https://help.shopee.vn/portal/4/article/190242 | 2026-09-20 / v1 | 8,125 | buyer; returns-policy; vi |
| 7 | shopee-chinh-sach-tra-hang-nguoi-mua.md | https://help.shopee.vn/portal/4/article/77251 | 2026-09-20 / v1 | 6,490 | buyer; returns-policy; vi |
| 8 | shopee-chinh-sach-tra-hang-nguoi-ban.md | https://help.shopee.vn/portal/4/article/77251 | 2026-09-20 / v1 | 8,570 | seller; returns-policy; vi |

**Danh sách kiểm tra quản trị dữ liệu (Data governance checklist):**
- [x] Tài liệu được lấy từ trang hỗ trợ Shopee công khai, không chứa dữ liệu cá nhân.
- [x] Mỗi tài liệu có metadata về `doc_id`, `audience`, `category`, `language`, `source_url`.

### Cấu trúc Metadata (Metadata Schema)

| Trường metadata | Kiểu | Ví dụ giá trị | Tại sao hữu ích cho truy xuất |
|----------------|------|---------------|-------------------------------|
| `doc_id` | string | `shopee-phuong-thuc-va-phi-tra-hang` | Xác định đúng tài liệu cần truy xuất |
| `audience` | enum | `buyer` | Lọc đúng đối tượng hỏi |
| `category` | enum | `returns-policy` | Lọc theo nhóm chính sách |
| `language` | string | `vi` | Phân biệt tiếng Việt |
| `source_url` | string | URL chính thức Shopee | Đảm bảo provenance |
...
Trong benchmark thực tế bằng Gemini, nhóm đánh giá ba chiến lược trên cùng bộ tài liệu chính sách Shopee:

| Tài liệu | Chiến lược | Số chunk | Độ dài TB | Nhận xét |
|-----------|-----------|----------|-----------|----------|
| shopee-quy-dinh-chung-tra-hang-hoan-tien.md | FixedSize | 12 | 489 | ổn định, nhưng có thể cắt điều khoản |
| shopee-quy-dinh-chung-tra-hang-hoan-tien.md | Sentence | 15 | 390 | giữ nguyên câu, phù hợp với điều kiện |
| shopee-quy-dinh-chung-tra-hang-hoan-tien.md | Recursive | 16 | 365 | giữ cấu trúc tốt hơn |
| shopee-huong-dan-gui-yeu-cau-tra-hang.md | FixedSize | 7 | 452 | dễ tách bước nhưng nguy cơ cắt ở ranh giới |
| shopee-phuong-thuc-va-phi-tra-hang.md | FixedSize | 11 | 489 | chunk dài gần giới hạn |
| shopee-huong-dan-chuan-bi-bang-chung.md | Recursive | 9 | 340 | giữ tốt bằng chứng và bước yêu cầu |

### Chiến lược của từng thành viên

**Thành viên 1 — Phan Thị Khánh Linh**
- **Loại chiến lược:** `FixedSizeChunker(chunk_size=500, overlap=50)`
- **Lý do chọn:** Là baseline dễ hiểu, dễ kiểm soát, cho phép đo rõ hiệu quả của overlap và chunk size.
- **Kết quả:** Với câu trả lời về thời hạn, thủ tục và điều kiện, fixed-size vẫn làm tốt khi từ khóa rõ, nhưng dễ mất ngữ cảnh ở các câu dài/điều kiện phức tạp.

**Thành viên 2 — Trương Hoàng Thành An**
- **Loại chiến lược:** `SentenceChunker(max_sentences_per_chunk=8)`
- **Lý do chọn:** Tách theo ranh giới câu rồi gom tối đa 8 câu/chunk, giúp giữ nguyên con số, điều kiện và ngoại lệ trong khi giảm số request embedding API. Chiến lược này phù hợp với hai policy dài vì không cắt giữa câu như fixed-size.
- **Kết quả:** Có xu hướng cho precision cao hơn trên câu hỏi đòi hỏi mốc thời gian và điều kiện áp dụng.

**Thành viên 3 — Nguyễn Thị Minh Tiến**
- **Loại chiến lược:** `RecursiveChunker`
- **Lý do chọn:** Ưu tiên giữ các đoạn / heading / cấu trúc logic. Phù hợp với tài liệu chính sách dài nhưng có mục rõ ràng.
- **Kết quả:** Hiệu quả tốt khi trả lời các câu hỏi liên quan đến quy trình và chứng cứ cần chuẩn bị.

**Thành viên 4 — Lưu Quang Khải**
- **Loại chiến lược:** Metadata-aware search + chunking ngắn hơn
- **Lý do chọn:** Dùng metadata `audience`, `category`, `language` để lọc trước, giảm nhiễu và giữ đúng tài liệu người mua.
- **Kết quả:** Hữu ích khi câu hỏi liên quan đến nhóm đối tượng, nhưng không quá chặt để tránh mất tài liệu liên quan.

### So Sánh Giữa Các Thành Viên

| Thành viên | Chiến lược | Điểm truy xuất (/10) | Điểm mạnh | Điểm yếu |
|-----------|-----------|----------------------|-----------|----------|
| Phan Thị Khánh Linh | FixedSize | 8.0 | Dễ kiểm soát, ổn định | Có thể cắt giữa câu |
| Trương Hoàng Thành An | Sentence | 8.5 | Giữ ý trọn câu, phù hợp điều khoản có số liệu | Nhiều chunk nếu câu dài |
| Nguyễn Thị Minh Tiến | Recursive | 8.8 | Giữ cấu trúc tài liệu tốt | Cần param tốt để tránh chunk quá nhỏ |
| Lưu Quang Khải | Metadata-aware | 9.0 | Tránh nhiễu, chỉ giữ tài liệu đúng nhóm | Nếu filter quá chặt thì có thể bỏ sót |

**Chiến lược nào tốt nhất cho chủ đề này?**
Kết hợp `SentenceChunker` hoặc `RecursiveChunker` với metadata filtering là tốt nhất cho chính sách Shopee. Các câu hỏi trong chủ đề này thường đòi hỏi sự chính xác ở các điều kiện, mốc thời gian và ngoại lệ, nên chunk phải giữ nguyên ý câu và metadata phải lọc đúng nhóm `buyer` / `seller` / `returns-policy`.
...
| # | Câu hỏi (Query) | Câu trả lời chuẩn (Gold Answer) | Tài liệu liên quan |
|---|-------|-------------------------------|-------------------|
| 1 | Người mua có thể yêu cầu Trả hàng/Hoàn tiền trong những trường hợp nào, và thời hạn gửi yêu cầu là bao lâu? | Có thể khi không nhận được hàng, thiếu hàng, sai hàng, hàng lỗi, hàng không đúng mô tả, hàng giả/nhái hoặc đã qua sử dụng. Thời hạn thường là 24 giờ với thực phẩm tươi sống, 15 ngày cho các đơn khác; các đơn người bán tự vận chuyển có thời hạn khác. | shopee-chinh-sach-tra-hang-nguoi-mua.md |
| 2 | Người mua cần thực hiện những bước nào để gửi yêu cầu Trả hàng/Hoàn tiền trực tiếp từ trang đơn hàng? | Vào đơn hàng > chọn Trả hàng/Hoàn tiền > chọn lý do > tải ảnh/video > điền mô tả > gửi yêu cầu. | shopee-huong-dan-gui-yeu-cau-tra-hang.md |
| 3 | Nếu chọn “Tự sắp xếp” để trả hàng, người mua phải trả phí và cần điều kiện gì để được Shopee hỗ trợ hoàn phí? | Người mua phải thanh toán cước phí trước, cung cấp mã vận đơn hợp lệ và điều kiện giao thành công; đủ điều kiện thì Shopee hỗ trợ hoàn phí trong 3–5 ngày làm việc. | shopee-phuong-thuc-va-phi-tra-hang.md |
| 4 | Với thẻ tín dụng/ghi nợ, tiền hoàn được trả về đâu và trong bao lâu? | Tiền được hoàn về thẻ gốc và thường mất 7–14 ngày làm việc tùy ngân hàng. | shopee-thoi-gian-va-cach-kiem-tra-tien-hoan.md |
| 5 | Khi khiếu nại hàng lỗi, video bằng chứng cần có gì và phải bổ sung trong bao lâu nếu Shopee yêu cầu? | Video cần quay rõ ràng, đủ sáng, thể hiện toàn bộ kiện hàng, mã vận đơn và lỗi; phải bổ sung trong vòng 24 giờ nếu được yêu cầu. | shopee-huong-dan-chuan-bi-bang-chung.md |

### Tổng hợp chất lượng truy xuất của nhóm

Benchmark thực tế bằng Gemini cho thấy tất cả 5 câu hỏi có top-3 chứa chunk liên quan. Kết quả cụ thể:

| # | Câu hỏi | Top-1 thực tế | Score top-1 | Top-3 có liên quan? |
|---|---------|---------------|-------------|----------------------|
| 1 | Trả hàng/hoàn tiền và thời hạn | shopee-chinh-sach-tra-hang-nguoi-mua | 0.7811 | Có |
| 2 | Gửi yêu cầu từ đơn hàng | shopee-huong-dan-gui-yeu-cau-tra-hang | 0.7919 | Có |
| 3 | Tự sắp xếp và hoàn phí | shopee-phuong-thuc-va-phi-tra-hang | 0.8031 | Có |
| 4 | Tiền hoàn về thẻ tín dụng | shopee-thoi-gian-va-cach-kiem-tra-tien-hoan | 0.7629 | Có |
| 5 | Video bằng chứng và 24 giờ | shopee-huong-dan-chuan-bi-bang-chung | 0.8284 | Có |

**Lọc bằng metadata có giúp ích không?**
Có, nhưng không quá mạnh. Với câu hỏi về thẻ tín dụng/hoàn tiền, `search()` và `search_with_filter(category='returns-policy', audience='buyer')` cho cùng top-3, nghĩa là metadata không làm cải thiện đáng kể trong trường hợp này vì các tài liệu cùng nhóm rất tương đồng. Tuy nhiên, metadata rất hữu ích khi dữ liệu có cả tài liệu người bán và người mua, vì filter giúp loại nhiễu theo đối tượng.

---

## 4. Thuyết trình (Demo) & Bài học nhóm — Nhóm (5 điểm)

**Những insight quan trọng nhóm sẽ trình bày:**
- Chiến lược `SentenceChunker` hoặc `RecursiveChunker` giữ tốt điều kiện và thời hạn hơn `FixedSize`.
- Metadata `audience` và `category` giúp giảm nhiễu khi cả chính sách người mua và người bán cùng tồn tại.
- Benchmark thực tế bằng Gemini cho thấy top-1 thường nằm đúng tài liệu mục tiêu, đặc biệt với các câu hỏi về “thời hạn”, “phương thức”, và “bằng chứng”.

**Bài học rút ra:**
Nên kết hợp chunking theo ý với metadata filtering. Nếu chỉ dùng fixed-size, hệ thống dễ cắt giữa điều kiện/hạn định; nếu chỉ dùng search không filter, kết quả có thể lẫn giữa chính sách người mua và người bán.

**Nếu làm lại:**
Nhóm sẽ thu thập thêm metadata như `retrieved_at`, `document_version`, và `title`, đồng thời phân tách frontmatter khỏi nội dung trước khi chạy benchmark để đo lường chunking chính xác hơn.
...
| Thuyết trình (Demo) | 5 / 5 |# Báo Cáo Nhóm — Lab 7: Embedding & Vector Store
